...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user_queries', function (Blueprint $table) {
            ...
            $table->foreignId('reply_by')->unsigned()->nullable()->references('id')->on('users')->onDelete('cascade');
            $table->tinyInteger('status')->default(0)->comment('0=>pending, 1=>replied,2=>closed');
            $table->timestamps();
        });
    }
