                        ...
                        <table class="table wemu-listener-table m-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Top Genre</th>
                                    <th class="text-center">Stream Hours</th>
                            ...
                            <tbody>
                                @php
                                $genres = ['Synthwave 🌌', 'Indie Rock 🎸', 'Lo-Fi Hip-Hop ☕', 'Modern Pop 🎤', 'Classic Jazz 🎷'];
                                $hours = ['482 hrs', '1,240 hrs', '84 hrs', '312 hrs', '610 hrs'];
                                $tiers = [
                                ['label' => 'Premium Gold', 'icon' => '👑', 'class' => 'wemu-tier-gold'],
                                ['label' => 'Family Plan', 'icon' => '👥', 'class' => 'wemu-tier-family'],
                                ['label' => 'Free Tier', 'icon' => '🎧', 'class' => 'wemu-tier-free'],
                                ];
                                @endphp
                                ...
                                <tr class="wemu-listener-row">
                                    ...
                                    <td class="text-center">
                                        <span class="wemu-tier-pill {{ $tier['class'] }}">
                                    ...
                                    {{-- Top Genre (Static) --}}
                                    <td class="text-center">
                                        <span class="wemu-genre-chip">{{ $genre }}</span>
                                    </td>

                                    {{-- Stream Hours (Static) --}}
                                    <td class="text-center fw-bold text-gray-800 fs-7">{{ $hour }}</td>
