                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted">Service Frequency</li>
                                    </ul>
                                </div>
                                @can('view-service-frequency')
                                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            <button type="button" class="btn btn-dark goTo"
                                                data-action="{{ route('admin.frequency.add') }}">Add
                                                Service Frequency</button>
                                        </div>
                                    </div>
                                @endcan
                            </div>
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                @forelse ($details as $detail)
                                                    <tr>
                                                        ...
                                                        <td>{{ $detail->day_count ?? 'N/A' }}</td>
                                                        <td>
                                                            <div class="form-check form-switch">
                                                                <input type="checkbox" data-uuid="{{ $detail->uuid }}"
                                                                    data-table="service_frequencies"
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                data-kt-menu="true">
                                                                @can('edit-service-frequency')
                                                                    <div class="menu-item px-3">
                                                                        <a class="menu-link px-3"
                                                                            href="{{ route('admin.frequency.edit', $detail->uuid) }}">Edit</a>
                                                                    </div>
                                                                @endcan
                                                                @can('delete-service-frequency')
                                                                    <div class="menu-item px-3">
                                                                        <a href="javascript:void(0)"
                                                                            data-table="service_frequencies"
