                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control" name="start_time" id="start_time"
                                                    value="{{ (!empty($details->start_time) && $details->start_time) ? date('H:i', strtotime($details->start_time)) : null }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                value="{{ (!empty($details->end_time) && $details->end_time) ? date('H:i', strtotime($details->end_time)) : null }}">
                                            </div>
                                        </div>
                                    </div>
