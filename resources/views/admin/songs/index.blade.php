...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <a href="{{ route('admin.songs.storeOrUpdate') }}" class="btn btn-sm btn-dark fw-bold">Upload Song</a>
            ...
            <!--begin::Menu 1-->
            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_62cfa2f3_songs">
                <div class="px-7 py-5">
                    <div class="fs-5 text-dark fw-bold">Filter Options</div>
                </div>
                <div class="separator border-gray-200"></div>
                <form action="{{ route('admin.songs.index') }}" method="GET" class="px-7 py-5">
                    <div class="mb-10">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('admin.songs.index') }}" class="btn btn-sm btn-light btn-active-light-primary me-2">Reset</a>
                    ...
                    <table class="table align-middle gs-0 gy-4 song-table mb-0">
                        <thead>
                            <tr class="fw-bold text-muted bg-transparent">
                                ...
                                <th class="min-w-150px">Artist</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="ps-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="{{ route('admin.songs.show', $song->id) }}" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $song->title }}</a>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    @if($song->album)
                                    <a href="{{ route('admin.albums.show', $song->album->id) }}" class="text-dark fw-semibold text-hover-primary d-block fs-7">{{ $song->album->title }}</a>
                                    @else
                                ...
                                <td>
                                    @if($song->artist)
                                    <a href="{{ route('admin.artist.view', $song->artist->uuid) }}" class="text-dark fw-semibold text-hover-primary d-block fs-7">{{ $song->artist->name }}</a>
                                    @else
                                    <span class="text-muted fw-semibold d-block fs-7">N/A</span>
                                    @endif
                                </td>
                                ...
                                <td class="text-end pe-6">
                                    <div class="d-flex justify-content-end align-items-center gap-1">
                                        <a href="{{ route('admin.songs.show', $song->id) }}" class="btn btn-icon btn-light btn-sm w-30px h-30px" title="Play / View Details">
                                            <i class="fa-solid fa-play fs-7 text-dark"></i>
                                        </a>
                                        <a href="{{ route('admin.songs.storeOrUpdate', $song->id) }}" class="btn btn-icon btn-light-primary btn-sm w-30px h-30px" title="Edit">
                                            <i class="fa-solid fa-pen-to-square fs-7"></i>
                                        </a>
                                        <form action="{{ route('admin.songs.destroy', $song->id) }}" method="POST" class="d-inline form-delete">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-10">
                                    <div class="d-flex flex-column align-items-center justify-content-center py-5">
                                        ...
                                        <a href="{{ route('admin.songs.storeOrUpdate') }}" class="btn btn-sm btn-dark fw-bold px-5 py-2">
        ...
        <div class="card clean-metric-card mb-5 mb-xl-10">
            ...
            <div class="card-body p-6 pt-3">
                ...
                <div class="release-item upcoming-release-item d-flex align-items-center justify-content-between pb-4 mb-4">
                    <div class="d-flex align-items-center">
                        <div class="symbol symbol-40px me-3">
                            <a href="{{ route('admin.songs.show', $upcomingRelease->id) }}">
                        ...
                        <div class="release-item-info">
                            <a href="{{ route('admin.songs.show', $upcomingRelease->id) }}" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $upcomingRelease->title }}</a>
