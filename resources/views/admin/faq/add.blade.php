                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{ route('admin.faq.list') }}"
                                    class="text-muted text-hover-primary">FAQ</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="card-body pt-6">
                            <div class="container">
                                <form id="faqForm" action="{{ route('admin.faq.add') }}" method="POST"
                                    ...
                                    <div class="row pt-4">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="answer" class="label-style">Answer</label>
                                                <span class="astrict_sign">*</span>
                                                <textarea class="form-control" name="answer" id="answer" cols="30" rows="4">{{ $details->answer ?? null }}</textarea>
                                            </div>
                                        </div>
                                    </div>
