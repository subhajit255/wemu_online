...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <!--begin::Menu 1-->
            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_artist_album_filter">
                <div class="px-7 py-5">
                    <div class="fs-5 text-dark fw-bold">Filter Options</div>
                </div>
                <div class="separator border-gray-200"></div>
                <form action="{{ route('artist.albums.index') }}" method="GET" class="px-7 py-5">
                    <div class="mb-10">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('artist.albums.index') }}" class="btn btn-sm btn-light btn-active-light-primary me-2">Reset</a>
